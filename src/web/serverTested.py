...
class WebServer:
    ...
    def start_mjpg_frame_updater(self):
        ...
        def frame_updater():
            ...
            while True:
                try:
                    # Get frame from Live2D streamer's camera
                    if (self.live2d_streamer.cap and 
    ...
    def run(self):
        ...
        self.logger.info("Features: Themes, Dashboard, Live2D Streaming, Plugin System, Configuration Management, MJPG Streaming")
